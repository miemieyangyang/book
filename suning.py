...
class SuningSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for li in li_list:
            ...
            for a in a_list:
                item["s_href"]=a.xpath("./href").etract_first()
                item["s_cate"]=a.xpath("./text()").etract_first()
                if item["s_href"] is not None:
                    item["s_href"]="http://snbook.suning.com/"+item["s_href"] #补充完整url地址
